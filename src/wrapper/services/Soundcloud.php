...
namespace boxhead\soundcloudsync\wrapper\services;

use boxhead\soundcloudsync\wrapper\services\Soundcloud\Version;
use boxhead\soundcloudsync\wrapper\services\Soundcloud\exceptions\SoundcloudUnsupportedAudioFormatException;
use boxhead\soundcloudsync\wrapper\services\Soundcloud\exceptions\SoundcloudInvalidHttpResponseCodeException;
use boxhead\soundcloudsync\wrapper\services\Soundcloud\exceptions\SoundcloudMissingClientIdException;
use boxhead\soundcloudsync\wrapper\services\Soundcloud\exceptions\SoundcloudUnsupportedResponseFormatException;
...
class Soundcloud
{
     ...
     *
     * @return void
     * @throws SoundcloudMissingClientIdException
     *
     * @access public
     */
    ...
    {
        if (empty($clientId)) {
            throw new SoundcloudMissingClientIdException();
        }
     ...
     *
     * @return string
     * @throws SoundcloudUnsupportedAudioFormatException
     *
     * @access public
     */
    function getAudioMimeType($extension)
    {
        if (array_key_exists($extension, self::$_audioMimeTypes)) {
            ...
            throw new SoundcloudUnsupportedAudioFormatException();
        }
    }
     ...
     *
     * @return object
     * @throws SoundcloudUnsupportedResponseFormatException
     *
     * @access public
     */
    function setResponseFormat($format)
    {
        if (array_key_exists($format, self::$_responseFormats)) {
            ...
            throw new SoundcloudUnsupportedResponseFormatException();
        }
     ...
     *
     * @return mixed
     * @throws SoundcloudInvalidHttpResponseCodeException
     *
     * @access protected
     */
    protected function _request($url, $curlOptions = array())
    {
        ...
        if ($this->_validResponseCode($this->_lastHttpResponseCode)) {
            ...
            throw new SoundcloudInvalidHttpResponseCodeException(
                null,
                0,
